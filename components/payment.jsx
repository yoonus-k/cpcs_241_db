          ...
          <div className="w-full lg:w-3/5">
            <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
              <Card>
                ...
                <CardFooter className="flex justify-around mb-14 ">
                  <TERipple rippleColor="light" className="w-4/6">
                    <div
                      onClick={() => {
                        makePayment();
                      }}
                      className="flex h-12 justify-center items-center rounded-lg bg-neutral-800 dark:bg-neutral-900"
                    >
                      <p className="text-neutral-50">Make Payment</p>
                    </div>
                  </TERipple>
                </CardFooter>
              </Card>
