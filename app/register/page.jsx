              ...
              <div className="g-0 ">
                <Tabs defaultValue="buyer" className="w-full text-center">
                  ...
                  <TabsContent value="seller" className="flex justify-center">
                    <div className="px-4 md:px-0 lg:w-6/12">
                      <div className="md:mx-6 md:p-12">
                        ...
                        >
                          <p className="mb-4">
                            Please register your seller account
                          </p>
                          {/* <!--Username input--> */}
                          <TEInput
                            type="text"
                  ...
                  <TabsContent value="agent" className="flex justify-center">
                    <div className="px-4 md:px-0 lg:w-6/12 ">
                      <div className="md:mx-6 md:p-12  bg-cover pointer-events-none">
                        <div className="overlay relative top-80 w-full h-full flex justify-center ">
                          <h1 className="z-50 font-serif text-5xl opacity-80">
                            coming soon
                          </h1>
                        </div>
                        {/* <!--Logo--> */}
